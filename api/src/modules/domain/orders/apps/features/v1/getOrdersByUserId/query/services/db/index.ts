...
export interface IGetOrderByUserIdDbService
	extends IServiceHandlerAsync<GetOrdersByUserIdRequestDto, OrderEntity[]> {}

@sealed
@Service()
export class GetOrdersByUserIdDbService implements IGetOrderByUserIdDbService {
	public handleAsync(
		params: GetOrdersByUserIdRequestDto
	): Promise<Result<OrderEntity[], ResultError>> {
		return tryCatchResultAsync(async () => {
			...
			// Filter
			const orders = Enumerable.from(orderMockData)
