...
export interface IDashboardDataFetchMapForWebService
	extends IServiceHandlerAsync<
		DashboardDataFetchRequestDto,
		Web.DashboardDataFetchResponseData
	> {}
...
export class DashboardDataFetchMapForWebService implements IDashboardDataFetchMapForWebService {
	public handleAsync(
	...
	): Promise<Result<Web.DashboardDataFetchResponseData, ResultError>> {
		return tryCatchResultAsync(async () => {
			...
			const response: Web.DashboardDataFetchResponseData =
