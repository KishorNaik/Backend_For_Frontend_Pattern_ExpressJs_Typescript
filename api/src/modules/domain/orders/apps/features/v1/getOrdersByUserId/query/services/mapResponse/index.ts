...
export interface IGetOrdersByUserIdMapResponseService
	extends IServiceHandlerAsync<Array<OrderEntity>, Array<GetOrdersByUserIdResponseDto>> {}

@sealed
@Service()
export class GetOrdersByUserIdMapResponseService implements IGetOrdersByUserIdMapResponseService {
	public handleAsync(
		params: Array<OrderEntity>
	): Promise<Result<Array<GetOrdersByUserIdResponseDto>, ResultError>> {
		return tryCatchResultAsync(async () => {
			...
			// Map Response
			const response = Enumerable.from(params)
